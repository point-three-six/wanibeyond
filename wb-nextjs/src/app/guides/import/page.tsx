...
export default function Page() {
    return (
        <div className='max-width'>
            ...
            <a id="basics"><h2 className='text-xl font-bold text-slate-700 dark:text-inherit mt-8'>Basics</h2></a>
            <div className='mt-2'>
            ...
            <a id="special-columns"><h2 className='text-xl font-bold text-slate-700 dark:text-inherit mt-8'>Item Fields</h2></a>
            <div className='mt-2'>
            ...
            <a id="special-columns"><h2 className='text-xl font-bold text-slate-700 dark:text-inherit mt-8'>Special Columns</h2></a>
            <div className='mt-2'>
