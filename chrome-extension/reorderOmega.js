"use strict";
// ==UserScript==
// @name         Wanikani: Reorder Omega Hijacked
...
(function () {
    return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            switch (page) {
                                ...
                                case 'lessons':
                                case 'extra_study':
                                    console.log('building original queue')
                                    console.log('get_queue_ids()')
                                    console.log(get_queue_ids())
                                    console.log(get_queue_ids().map(function (id) { return items_by_id[id]; }))
                                    debugger;
        ...
        function transform_item(item) {
            ...
            switch (item.object) {
                case 'vocabulary':
                    return __assign(__assign({}, mutual), {
                        aud: (_f = item.data.pronunciation_audios) === null || _f === void 0 ? void 0 : _f.map(function (audio) {
                            return ({
